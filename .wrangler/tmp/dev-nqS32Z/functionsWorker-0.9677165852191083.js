...
// .wrangler/tmp/bundle-4verzz/checked-fetch.js
...
// .wrangler/tmp/pages-pjUAFG/functionsWorker-0.9677165852191083.mjs
...
__name(respond2, "respond2");
__name2(respond2, "respond");
...
__name(respond3, "respond3");
__name2(respond3, "respond");
...
__name(hashCode2, "hashCode2");
__name2(hashCode2, "hashCode");
...
__name(respond4, "respond4");
__name2(respond4, "respond");
...
__name(hashCode3, "hashCode3");
__name2(hashCode3, "hashCode");
...
__name2(getSceneByIdentifier, "getSceneByIdentifier");
...
__name2(getCommentWithAuthor, "getCommentWithAuthor");
...
__name2(mapCommentRecord, "mapCommentRecord");
var DEFAULT_HEADERS = {
  "Access-Control-Allow-Origin": "*",
...
__name2(optionalAuth, "optionalAuth");
...
__name2(buildCommentTree, "buildCommentTree");
async function handleGet(request, env) {
  ...
  if (likedMap.size > 0) {
    const markLiked = /* @__PURE__ */ __name2((nodes) => {
      nodes.forEach((node) => {
...
__name2(resolveScene, "resolveScene");
...
__name2(fetchScenes, "fetchScenes");
...
// .wrangler/tmp/bundle-4verzz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4verzz/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9677165852191083.js.map
